...
def main(args):
    model_checkpoint = args.model_checkpoint  # "facebook/bart-base" # model_checkpoint = "t5-small"
    ...
    def preprocess_function(examples):
        model_inputs = tokenizer(
            examples["dialogue"], max_length=512, truncation=True
        )
    ...
    wandb.login()
    wandb.init(project="TextSummarization", name=f"{model_checkpoint}-{dataset_name}")
...
if __name__ == "__main__":
    ...
    parser.add_argument('--model_checkpoint', required=True, help="facebook/bart-base or t5-small")
